  ...
  observe({
    ...
    output$location <- renderPlot({
      df %>%
        ...
        labs(x = "", y = "Total Penjualan", title = "Penjualan Per Kota",  face = "bold") +  # Update label sumbu dan judul
    ...
    output$time <- renderPlot(
      if (input$time == 1) {
        df %>% # Gagal mengurutkan hari dalam seminggu yang ditampilkan. # Tidak dapat melakukan plot garis
          ...
          xlab('Weekdays') +
          ggtitle('Penjualan rata-rata per hari kerja') +
          theme_minimal() + 
        ...
        df %>%
          ...
          theme_minimal() +  
          ylab('Total penjualan') +
          xlab('Jam kerja harian') +
          ggtitle('Penjualan rata-rata per jam') +
          theme(axis.text=element_text(size=20),
                axis.title=element_text(size=20),
                plot.title = element_text(size = 20)) +
          theme(plot.title = element_text(hjust = 0.5))}
    ...
    output$salesoverview <- renderPlot(
      if (input$salesoverview == 1) {
        df %>% 
          ...
          ylab('Total penjualan') +
          xlab('Gender') + 
          ggtitle('Total penjualan per gender') +
          theme_minimal() +
          theme(axis.text=element_text(size=20),
                axis.title=element_text(size=20),
                plot.title = element_text(size = 20)) +
        ...
        df %>%
          ...
          ylab('Jenis produk') +
          xlab('Total penjualan') +
          ggtitle('Total penjualan per jenis produk') +
          theme_minimal() +
          theme(axis.text=element_text(size=20),
                axis.title=element_text(size=20),
                plot.title = element_text(size = 20)) +
        ...
        df %>% 
          ...
          ylab('Total Keanggotaan') +
          xlab('Rating') +
          ggtitle('Korelasi antara total penjualan dan rating') +
          theme(axis.text=element_text(size=20),
                axis.title=element_text(size=20),
                plot.title = element_text(size = 20)) +
          theme(plot.title = element_text(hjust = 0.5))
        ...
        df %>% 
          ...
          ylab('Total penjualan') +
          xlab('Keanggotaan') +
          ggtitle('Total penjualan per Keanggotaan') +
          theme(axis.text=element_text(size=20),
                axis.title=element_text(size=20),
                plot.title = element_text(size = 20)) +
          theme(plot.title = element_text(hjust = 0.5))}
    ...
    output$gender <- renderPlot(
      if (input$gender == 1) {
        df %>%
          ...
          ylab('Jenis produk') +
          xlab('Total Penjualan') +
          ggtitle('Total penjualan per jenis produk dan jenis kelaminr') +
          theme(axis.text=element_text(size=20),
                axis.title=element_text(size=20),
                plot.title = element_text(size = 20)) + 
          theme(plot.title = element_text(hjust = 0.5))
        ...
        df %>% 
          ...
          xlab('Keanggotaan') +
          ylab('Total Penjualan') +
          ggtitle('Keanggotaan berdasarkan gender') +
          theme(axis.text=element_text(size=20),
                axis.title=element_text(size=20),
                plot.title = element_text(size = 20)) +
          theme(plot.title = element_text(hjust = 0.5))
    ...
    output$membership <- renderPlot(
      df %>%
        ...
        ylab('Jenis produk') +
        xlab('Total Penjualan') +
        ggtitle('Total sales per jenis produk dan keanggotaan') +
        theme(axis.text=element_text(size=20),
              axis.title=element_text(size=20),
              plot.title = element_text(size = 20)) +
        theme(plot.title = element_text(hjust = 0.5))
    ...
    output$rating <- renderPlot(
      df %>% 
        ...
        ylab('Rating') +
        xlab('Keanggotaan') +
        ggtitle('Keanggotaan berdasarkan peringkat') +
        theme(axis.text=element_text(size=20),
              axis.title=element_text(size=20),
              plot.title = element_text(size = 20)) +
        theme(plot.title = element_text(hjust = 0.5)))
